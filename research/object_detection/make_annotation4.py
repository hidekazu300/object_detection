...
Make_PicXML_2( 'sample/home' , 'images/test' , 'images/test' , [aug1,aug2,aug3,aug4,aug5], pic_num )
Make_PicXML_2( 'sample/zoo' , 'images/test' , 'images/test' , [aug1,aug2,aug3,aug4,aug5], pic_num ,start =pic_num)
Make_PicXML_2( 'sample/mj' , 'images/test' , 'images/test' , [aug1,aug2,aug3,aug4,aug5], pic_num ,start =pic_num*2 )


# In[10]:


Make_PicXML_2( 'sample/home' , 'images/train' , 'images/train' , [aug1,aug2,aug3,aug4,aug5], test_num )
Make_PicXML_2( 'sample/zoo' , 'images/train' , 'images/train' , [aug1,aug2,aug3,aug4,aug5], test_num ,start =test_num )
Make_PicXML_2( 'sample/mj' , 'images/train' , 'images/train' , [aug1,aug2,aug3,aug4,aug5], test_num ,start =test_num*2 )

print("Train Num :{}".format(pic_num*3*5))
print("Test Num :{}".format(test_num*3*5))